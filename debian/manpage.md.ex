% libvirt-udev-dlitz(SECTION) | User Commands
%
% "September 14 2024"
...
libvirt-udev-dlitz - program to do something

# SYNOPSIS

**libvirt-udev-dlitz** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**libvirt-udev-dlitz** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **libvirt-udev-dlitz** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**libvirt-udev-dlitz** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    libvirt-udev-dlitz. See **foo.conf**(5) for further details.
...
**libvirt-udev-dlitz** provides some return codes, that can be used in scripts:
